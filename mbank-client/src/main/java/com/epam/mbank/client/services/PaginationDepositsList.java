...
@Stateless(name = "client/PaginationDepositsList")
...
public class PaginationDepositsList implements PaginationList<Deposit> {
	...
	public List<Deposit> getItemsPerPage(Long id, int page) throws NoSuchItem {
	...
	public int getItemsCoutn(Long id) throws NoSuchItem {
		Client client = clientService.getClient(id);
		return depositService.getCountOfDeposits(client);
	}
